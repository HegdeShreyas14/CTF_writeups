...
const SELF_HOST = "http://localhost:1337";

// export SELF_HOST so the internal bot (if started) can log/use it
process.env.SELF_HOST = SELF_HOST;

// start internal bot that listens for socket messages and visits the URLs
// require("./bot.js");

const MAX_INPUT_LENGTH = 4000;
const MAX_NUM_INPUT_LENGTH = 5;
const MAX_BOOK_COUNT = 20;
const BACKEND_ERROR_MSG = "Internal server error";
const ADMIN_LOCKED_MSG = "Admin only";
